...
# at 10% (.58-.68), before the newer strategic reward bands.
require("if(roll<0.53){sm.aviaryTickets+=1;")
require("if(roll<0.58){const tax=pick(TC_COVENANT_TAXES);")
require("if(roll<0.68){sm.freeBossKills+=1;return {kind:'freeboss',label:'Sanctioned Boss Kill'")
